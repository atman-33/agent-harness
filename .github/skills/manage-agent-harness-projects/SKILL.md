...
description: Manages agent-harness project configuration, including switching the active project, creating project profiles, and updating work-unit repository settings. Use when working in agent-harness on config/agent-harness.yaml or projects/*.yaml, or when the user asks to switch projects, add a project, or change openspec_root, primary_repo, repos[], follow_files, or default_checks.
...
- Switch the active project:
  `python .github/skills/manage-agent-harness-projects/scripts/manage_agent_harness_projects.py set-active --project-id my-project`
- Create a project profile:
  `python .github/skills/manage-agent-harness-projects/scripts/manage_agent_harness_projects.py create-profile --project-id my-project --openspec-root ../my-project --primary-repo app --summary "Short description" --repo-json '{"id":"app","root":"../my-project"}'`
- Validate a profile:
...
1. Read `config/agent-harness.yaml` and the target file under `projects/`.
...
- Keep `primary_repo` aligned with one repo id in `repos[]`.
