 ...
 * @property {string} pluginRef   e.g. "engineering@atman-marketplace"
 ...
 * E.g. engineering@atman-marketplace -> ~/.claude/plugins/marketplaces/atman-marketplace/plugins/engineering
 */
